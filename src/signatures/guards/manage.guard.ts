...
import { getSignatureAuthorizationData } from './utils';

@Injectable()
export class ManageSignatureGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const template = await getSignatureAuthorizationData(
      request,
